...
## 2025-05-15 - [UX/A11y] Accessible Collapsible and Transient Feedback
**Learning:** For utility panels like "Debug", combining explicit ARIA relationship attributes (aria-expanded/controls) with transient inline feedback ("✅ Copied!") provides a superior experience over disruptive modal alerts while maintaining full screen reader context.
**Action:** Use the `DebugPanel` pattern as the standard for accessible, non-intrusive utility features in this app.
