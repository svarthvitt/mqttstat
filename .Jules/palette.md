...
## 2026-04-12 - Loading and Error State Accessibility
**Learning:** Generic loading and error messages are often invisible to screen readers if they are not correctly marked with ARIA roles.
**Action:** Use role="status" and aria-live="polite" for informational updates like loading, and role="alert" with aria-live="assertive" for critical errors.
