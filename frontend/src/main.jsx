...
function DebugPanel() {
  ...
  const onCopyLogs = async () => {
    ...
    try {
      ...
      // no-op: user can still see the button text doesn't change or use Download
    }
  }
  ...
  return (
    <aside className={`debug-panel ${open ? 'open' : ''}`}>
      ...
      {open ? (
        <div className="debug-content" id="debug-panel-content" role="region" aria-label="Debug logs">
