...
function DebugPanel() {
  ...
  return (
    <aside className={`debug-panel ${open ? 'open' : ''}`}>
      ...
      {open ? (
        <div className="debug-content" id="debug-panel-content" role="region" aria-label="Debug logs and settings">
          ...
          <div className="debug-actions">
            <button type="button" onClick={onCopyLogs} disabled={!entries.length || copied}>
