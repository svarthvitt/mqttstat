...
@app.get(
    ...
    summary="Combined topic history and statistics",
    tags=["topics"],
)
def get_topic_detail(
    ...
    """
    Combined endpoint for history and stats.
    Performance: Reduces network roundtrips for the TopicDetailPage by 50%
    by consolidating history and aggregate statistics into a single response.
    """
